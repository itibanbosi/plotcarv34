...
//% color="#3943c6" block="Plotcar Plotcar Ver3.4" weight=95 icon="\uf1b9"
namespace eureka_plotter_car {
    ...
    //% block=" |%zengo|  |%F_cm|  cm" group="2 Basic movement"
...
export function plottercar_houkou(muki: houkou): void {
    ...
    //% color="#ff3d03" weight=35 blockId=auto_led_off block="micro:bi LED |%Matrix_LED|" group="4 Initial setting"
    ...
    /*
        //% color="#009A00" weight=21 blockId=sonar_ping_LED block="Display distance" group="6 Distance sensorｰ"
        //% advanced=true
    ...
    */
    ...
    //% color="#009A00" weight=30 block="(minimam 5cm) dstance |%limit| cm  |%nagasa| " group="6 Ultrasonic_Distance sensorｰ"
    ...
    //% color="#6041f1"  weight=35 block="Both |%wb| stepping on threshold threshold |%sikii| " group="7 "
    //% advanced=true
    ...
    //% color="#009A00"  weight=19 blockId=microbit2_decideLight block="m:bitOptical sensor value |%limit| Darker" group="8 microbit Optical_senso"
